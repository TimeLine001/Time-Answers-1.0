...
<div id="wrapper">
	...
	if(isset($_POST['submit'])){
		...
		if(!isset($error)){
			...
			try {
				...
				$stmt = $db->prepare('UPDATE blog_posts_seo SET postTitle = :postTitle, postSlug = :postSlug, postDesc = :postDesc, postCont = :postCont,Dept=:Dept WHERE postID = :postID') ;
				$stmt->execute(array(
					':postTitle' => $postTitle,
					':postSlug' => $postSlug,
					':postDesc' => $postDesc,
	...
	if(isset($error)){
		...
		try {
			...
			$stmt = $db->prepare('SELECT postID, postTitle, postDesc, postCont,Dept FROM blog_posts_seo WHERE postID = :postID') ;
